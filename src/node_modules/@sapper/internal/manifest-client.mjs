...
export const ignore = [/^\/blog\.json$/, /^\/blog\/posts\/markdown-test\/?$/, /^\/blog\/posts\/hello-world\/?$/, /^\/blog\/([^\/]+?)\.json$/];
...
if (typeof window !== 'undefined') {
	import("/Users/rich/development/no-blockers/no-blockers-frontend/node_modules/sapper/sapper-dev-client.js").then(client => {
