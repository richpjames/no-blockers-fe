...
<div class="${"container"}"><h1>About</h1>
  <figure class="${"svelte-1t712sc"}"><img src="${"rsz_florian-klauer-489-unsplash.jpg"}" alt="${"A vintage typewriter."}" class="${"svelte-1t712sc"}">
    <figcaption>Photo by <a href="${"https://unsplash.com/@florianklauer"}" target="${"_blank"}">Florian Klauer</a> on Unsplash</figcaption></figure>
  <p>Text placeholder via <a href="${"https://jeffsum.com/"}" target="${"_blank"}">Jeffsum</a>.</p>
  <p>So you two dig up, dig up dinosaurs? What do they got in there? King Kong? My dad once told me, laugh and the world laughs with you, Cry, and I&#39;ll give you something to cry about you little bastard! Life finds a way. God creates dinosaurs. God destroys dinosaurs. God creates Man. Man destroys God. Man creates Dinosaurs.</p>
  <p>You really think you can fly that thing? You know what? It is beets. I&#39;ve crashed into a beet truck. Forget the fat lady! You&#39;re obsessed with the fat lady! Drive us out of here! Is this my espresso machine? Wh-what is-h-how did you get my espresso machine?</p>
  <p>Hey, you know how I&#39;m, like, always trying to save the planet? Here&#39;s my chance. Hey, take a look at the earthlings. Goodbye! I was part of something special. Just my luck, no ice. You&#39;re a very talented young man, with your own clever thoughts and ideas. Do you need a manager?</p>
  <p>Jaguar shark! So tell me - does it really exist? This thing comes fully loaded. AM/FM radio, reclining bucket seats, and... power windows. Yes, Yes, without the oops! You&#39;re a very talented young man, with your own clever thoughts and ideas. Do you need a manager?</p>
  <p>Yes, Yes, without the oops! Do you have any idea how long it takes those cups to decompose. They&#39;re using our own satellites against us. And the clock is ticking. Do you have any idea how long it takes those cups to decompose. My dad once told me, laugh and the world laughs with you, Cry, and I&#39;ll give you something to cry about you little bastard!</p></div>`;
});
...
<div class="${"container"}">${each(posts, (post, index) => `${index ? `<hr class="${"svelte-ffk8g2"}">` : ``}
    <div class="${"post-item"}"><h2 class="${"svelte-ffk8g2"}"><a rel="${"prefetch"}" href="${"blog/" + escape(post.slug)}">${escape(post.title)}</a></h2>
      <p>${escape(post.excerpt)}</p>
      <div class="${"post-item-footer svelte-ffk8g2"}"><span class="${"post-item-date svelte-ffk8g2"}">— ${escape(post.printDate)}</span></div>
    </div>`)}</div>`;
});
...
const Bio = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"svelte-1ulceh0"}"><img src="${"profile-pic.png"}" alt="${"Maxi Ferreira"}" class="${"svelte-1ulceh0"}">
  <p class="${"svelte-1ulceh0"}">Hi, I&#39;m <strong>Maxi</strong>. I&#39;m a software engineer and data scientist from Córdoba, Argentina.
    You can follow me on <a href="${"https://www.twitter.com/Charca"}" target="${"_blank"}">Twitter</a>,
    see some of my work on <a href="${"https://www.github.com/Charca"}" target="${"_blank"}">GitHub</a>,
    or read more about me on <a href="${"https://www.maxiferreira.com"}" target="${"_blank"}">my website</a>.
  </p></div>`;
...
const U5Bslugu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${($$result.head += `${($$result.title = `<title>${escape(post.title)}</title>`, "")}<meta property="${"og:type"}" content="${"article"}"><meta property="${"og:title"}"${add_attribute("content", post.title, 0)}><meta name="${"Description"}"${add_attribute("content", post.excerpt, 0)}><meta property="${"og:description"}"${add_attribute("content", post.excerpt, 0)}><meta name="${"twitter:card"}" content="${"summary_large_image"}"><meta name="${"twitter:title"}"${add_attribute("value", post.title, 0)}><meta name="${"twitter:description"}"${add_attribute("content", post.excerpt, 0)}><meta name="${"twitter:label1"}" value="${"Published on"}"><meta name="${"twitter:data1"}"${add_attribute(
		"value",
		...
		0
	)}><meta name="${"twitter:label2"}" value="${"Reading Time"}"><meta name="${"twitter:data2"}"${add_attribute("value", post.printReadingTime, 0)}>`, "")}

<header class="${"svelte-1uh130i"}"><p class="${"svelte-1uh130i"}">${escape(post.printDate)} ~ ${escape(post.printReadingTime)}</p>
  <h1 class="${"svelte-1uh130i"}">${escape(post.title)}</h1>
  <hr class="${"svelte-1uh130i"}"></header>
<div class="${"container"}"><article class="${"content"}">${post.html}</article>
  <hr>
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<nav class="${"svelte-16fnwww"}"><a class="${escape(null_to_empty(segment === undefined ? "selected" : "")) + " svelte-16fnwww"}" href="${"."}">home</a>
  <a class="${escape(null_to_empty(segment === "about" ? "selected" : "")) + " svelte-16fnwww"}" href="${"about"}">about</a>
  <a rel="${"prefetch"}" class="${escape(null_to_empty(segment === "blog" ? "selected" : "")) + " svelte-16fnwww"}" href="${"blog"}">blog</a></nav>`;
});
...
const css$5 = {
	...
	map: "{\"version\":3,\"file\":\"Header.svelte\",\"sources\":[\"Header.svelte\"],\"sourcesContent\":[\"<script>\\n  import Nav from './Nav.svelte'\\n\\n  export let segment\\n</script>\\n\\n<style>\\n  header {\\n    display: flex;\\n    margin: 0 auto;\\n    max-width: 1400px;\\n    padding: 2em;\\n    width: 100%;\\n  }\\n</style>\\n\\n<header>\\n  <h1>no blockers</h1>\\n  <Nav {segment} />\\n</header>\\n\"],\"names\":[],\"mappings\":\"AAOE,MAAM,cAAC,CAAC,AACN,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,SAAS,CAAE,MAAM,CACjB,OAAO,CAAE,GAAG,CACZ,KAAK,CAAE,IAAI,AACb,CAAC\"}"
};
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<header class="${"svelte-y9ah38"}"><h1>no blockers</h1>
  ${validate_component(Nav, "Nav").$$render($$result, { segment }, {}, {})}</header>`;
});
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"layout svelte-v25qrq"}">${validate_component(Header, "Header").$$render($$result, { segment }, {}, {})}

  <main class="${"svelte-v25qrq"}">${slots.default ? slots.default({}) : ``}</main>

  <footer class="${"svelte-v25qrq"}"></footer></div>`;
});
