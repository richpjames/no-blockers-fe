...
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${($$result.head += `${($$result.title = `<title>Sapper Blog Template</title>`, "")}`, "")}

<div class="${"home-container svelte-1lllleo"}"><div class="${"home-copy svelte-1lllleo"}"><h1 class="${"svelte-1lllleo"}">Welcome to your new Sapper Blog</h1>
    <p class="${"svelte-1lllleo"}">Check out the docs on <a href="${"https://www.github.com/Charca/sapper-blog-template"}" target="${"_blank"}">GitHub</a> to get started.</p></div>

  <figure class="${"svelte-1lllleo"}"><img alt="${"Person typing on laptop"}" src="${"undraw-illustration.svg"}" class="${"svelte-1lllleo"}">
    <figcaption class="${"svelte-1lllleo"}">Illustration thanks to <a href="${"https://undraw.co"}" target="${"_blank"}">Undraw</a></figcaption></figure></div>`;
});
...
<div class="${"container"}"><h1>About</h1>
  <figure class="${"svelte-1t712sc"}"><img src="${"rsz_florian-klauer-489-unsplash.jpg"}" alt="${"Image of a vintage typewriter."}" class="${"svelte-1t712sc"}">
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<header class="${"svelte-y9ah38"}">${validate_component(Logo, "Logo").$$render($$result, {}, {}, {})}
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <footer class="${"svelte-v25qrq"}"><span>© ${escape(new Date().getFullYear())} Your Blog.
      Powered by <a href="${"https://sapper.svelte.dev"}" target="${"_blank"}">Sapper</a>.
      Template by <a href="${"https://www.twitter.com/Charca"}" target="${"_blank"}">Maxi Ferreira</a>.
    </span></footer></div>`;
});
